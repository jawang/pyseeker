...
Color coding:
1. Green corresponds successful break launches
2. Red corresponds to opcode 3, 4, and 5 messages that are not
	ignored or failed launches
3. Gray corresponds to opcode 0 messages, ignored messages
4. White corresponds to everything else
